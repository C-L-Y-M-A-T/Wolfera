  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        className={`relative h-2 w-full grow overflow-hidden rounded-full ${theme.background.backgroundColors.white}`}
      >
        <SliderPrimitive.Range
          className={`absolute h-full ${theme.background.backgroundColors.roles.werewolf} `}
        />
      </SliderPrimitive.Track>
