          ...
          <div className="space-y-6 py-4">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                The Werewolves of Miller's Hollow is a social deduction game
                where players are secretly assigned roles as either villagers or
                werewolves. The villagers must identify and eliminate all
                werewolves before they are eliminated themselves.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-blue-900/20 border border-blue-500/30 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400">
                    Find and eliminate all werewolves
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-blue-900/10 border border-blue-500/20 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs bg-blue-900/30 text-blue-300 border-blue-500"
                    >
                      Eyes Closed
                    </Badge>
                  </div>
                  <div className="space-y-2 text-sm text-gray-400">
                    ...
                    <p>
                      • Special roles (Seer, Doctor, Witch) perform their
                      actions
                    </p>
                ...
                <div className="p-4 bg-yellow-900/10 border border-yellow-500/20 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs bg-yellow-900/30 text-yellow-300 border-yellow-500"
                    >
                      Discussion
                    </Badge>
                  </div>
                  <div className="space-y-2 text-sm text-gray-400">
                    ...
                    <p>
                      • Players vote to eliminate someone they suspect is a
                      werewolf
                    </p>
                ...
                <div className="p-4 bg-red-900/10 border border-red-500/20 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs bg-red-900/30 text-red-300 border-red-500"
                    >
                      Elimination
                    </Badge>
                  </div>
                  <div className="space-y-2 text-sm text-gray-400">
                    ...
                    <p>
                      • In case of a tie, there may be a revote or no
                      elimination
                    </p>
                  </div>
                </div>
            ...
            <div className="p-4 bg-green-900/10 border border-green-500/20 rounded-lg">
              ...
              <ul className="text-sm text-gray-400 space-y-1">
                ...
                <li>
                  • Remember that werewolves will try to act like villagers
                </li>
              </ul>
            </div>
          </div>
