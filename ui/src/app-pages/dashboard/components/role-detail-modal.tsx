...
import { CheckCircle, Lightbulb, Target, Trophy } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] bg-gray-900 border-gray-700 max-h-[80vh]">
        <ScrollArea
          className={`${theme.typography.textColor.primary} max-h-[70vh]`}
        >
          <DialogHeader>
            ...
            <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              ...
              {role.team === "Good" ? (
                <p className="text-sm text-gray-400">
                  As a member of the Good team, you must work together with
                  other villagers to identify and eliminate the werewolves.
                  Communication and trust are key, but be careful who you reveal
                  your role to.
                </p>
              ) : (
                <p className="text-sm text-gray-400">
                  As a member of the Evil team, you must eliminate villagers
                  while maintaining your cover during the day. Coordinate with
                  your fellow werewolves and sow confusion among the villagers.
                </p>
              )}
            </div>
          </div>
