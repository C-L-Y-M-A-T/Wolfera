...
export function JoinByIdModal({ open, onOpenChange, onJoinGame }: JoinByIdModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] bg-gray-900 border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-xl text-blue-400">Join Game by ID</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="text-sm text-gray-400">
            <p>Enter the game ID provided by the host to join a private game.</p>
          </div>
        </div>
